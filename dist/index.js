...
${error2.stack}` : "Vitest Error",
  ...
  getAllErrors(tests) {
    ...
    tests.forEach((test) => {
      var _a, _b;
      const errs = (_b = (_a = test.result) == null ? void 0 : _a.errors) == null ? void 0 : _b.map((error2) => ({
        ...error2,
        file: test.file,
  ...
  getFormattedErrors(failedTests) {
    ...
    errors.forEach((error2) => {
      var _a;
      if (!(error2 == null ? void 0 : error2.stack)) {
        return;
      }
      ...
      const { file, line, col } = this.getErrorLocation(error2.stack, ((_a = error2.file) == null ? void 0 : _a.name) ?? "") ?? {};
      if (file && line && col) {
        const annotation = {
          file,
          startLine: line,
...
function breakTies(tiesToBreak, lines) {
  ...
  if (indexOfFirstLeadingComment) {
    ...
    if ((enclosingNode == null ? void 0 : enclosingNode.type) === "CallExpression") {
      --indexOfFirstLeadingComment;
    }
  }
...
var MagicastError = class extends Error {
  constructor(message, options) {
    ...
    this.options = options;
    if ((options == null ? void 0 : options.ast) && (options == null ? void 0 : options.code) && options.ast.loc) {
...
function parseModule(code, options) {
  const node = parse3(code, {
    parser: (options == null ? void 0 : options.parser) || getBabelParser(),
    ...options
  });
...
var GithubSummaryIstanbulCoverageReporter = class extends libReport2.ReportBase {
  ...
  async onEnd() {
    ...
    const prNumber = (_a = this.github.context.payload.pull_request) == null ? void 0 : _a.number;
    if (prNumber) {
...
export {
  GithubIstanbulCoverageProviderModule_default as GithubIstanbulCoverageProviderModule,
  GithubReporter
};
